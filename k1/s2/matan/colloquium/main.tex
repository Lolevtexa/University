...
\input{questions/1/auxiliary.tex}

\subsection*{Ответ на вопрос}
\input{questions/1/answer.tex}
...
\subsection*{Вспомогательные понятия}
\input{questions/2/auxiliary.tex}

\subsection*{Ответ на вопрос}
\input{questions/2/answer.tex}
